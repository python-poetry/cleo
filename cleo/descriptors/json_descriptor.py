...
class JsonDescriptor(Descriptor):
    ...
    def _describe_application(self, application, **options):
        ...
        if described_namespace:
            data = {"commands": commands, "namespace": described_namespace}
        else:
            data = {
                "commands": commands,
    ...
    def _get_input_definition_data(self, definition):
        ...
        return OrderedDict([("arguments", arguments), ("options", options)])
    ...
    def _get_command_data(self, command):
        ...
        return OrderedDict(
            [
                ...
                (
                    "definition",
                    self._get_input_definition_data(command.get_native_definition()),
                ),
            ]
        )
