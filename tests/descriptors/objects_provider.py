...
class ObjectsProvider(object):
    ...
    def get_input_arguments(cls):
        return {
            ...
            "input_argument_2": InputArgument(
                "argument_name", InputArgument.IS_LIST, "argument description"
            ),
            "input_argument_3": InputArgument(
                "argument_name",
                InputArgument.OPTIONAL,
                "argument description",
                "default_value",
            ),
            "input_argument_4": InputArgument(
                "argument_name",
    ...
    def get_input_options(cls):
        return {
            ...
            "input_option_3": InputOption(
                "option_name", "o", InputOption.VALUE_REQUIRED, "option description"
            ),
            "input_option_4": InputOption(
                "option_name",
                "o",
                InputOption.VALUE_IS_LIST | InputOption.VALUE_OPTIONAL,
                "option description",
            ),
            "input_option_5": InputOption(
                "option_name",
                "o",
                InputOption.VALUE_REQUIRED,
                "multiline\noption description",
            ),
            "input_option_6": InputOption(
                "option_name",
                ["o", "O"],
                InputOption.VALUE_REQUIRED,
    ...
    def get_commands(cls):
        return {"command_1": DescriptorCommand1(), "command_2": DescriptorCommand2()}
